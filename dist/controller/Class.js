...
function create_class(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { name, description, max_students, start_date, end_date } = req.body;
        if (!name || !max_students || !start_date || !end_date) {
...
function edit_class(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { classId, name, description, max_students, start_date, end_date } = req.body;
        if (!classId) {
            res.status(1002).json({ message: "Missing required fields." });
            return;
        }
        try {
            const classToUpdate = yield Class_1.Class.findOne({
                where: { id: classId, teacherId: req.user.accountId },
            });
            if (!classToUpdate) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const classList = yield Class_1.Class.findAll({
                where: { teacherId: req.user.accountId },
            });
