    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newAccount = yield Account_1.Account.create({
                ...
                role,
                state: enum_1.STATE.INACTIVE,
                id: (0, uuid_1.v4)(),
            });
            console.log(role === enum_1.ROLE.TEACHER);
...
function login(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const token = jsonwebtoken_1.default.sign({ id: account.id, username: account.username, role: account.role }, process.env.SECRET_KEY, { expiresIn: "1h" });
            let classList = [];
            ...
            res.status(200).json({
                ...
                active: account.state === enum_1.STATE.ACTIVE,
                role: account.role,
...
function check_verify_code(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (user.state === enum_1.STATE.INACTIVE) {
                console.log("first");
